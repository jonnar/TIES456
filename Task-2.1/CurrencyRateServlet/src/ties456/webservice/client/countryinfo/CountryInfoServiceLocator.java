...
public class CountryInfoServiceLocator extends org.apache.axis.client.Service implements CountryInfoService {
 ...
 */
    ...
    private java.lang.String CountryInfoServiceSoap12_address = "http://www.oorsprong.org/websamples.countryinfo/CountryInfoService.wso";
    ...
    public CountryInfoServiceSoapType getCountryInfoServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CountryInfoServiceSoapBinding12Stub _stub = new CountryInfoServiceSoapBinding12Stub(portAddress, this);
    ...
    public CountryInfoServiceSoapType getCountryInfoServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CountryInfoServiceSoapBindingStub _stub = new CountryInfoServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                CountryInfoServiceSoapBinding12Stub _stub = new CountryInfoServiceSoapBinding12Stub(new java.net.URL(CountryInfoServiceSoap12_address), this);
                _stub.setPortName(getCountryInfoServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                CountryInfoServiceSoapBindingStub _stub = new CountryInfoServiceSoapBindingStub(new java.net.URL(CountryInfoServiceSoap_address), this);
                _stub.setPortName(getCountryInfoServiceSoapWSDDServiceName());
                return _stub;
            }
        }
